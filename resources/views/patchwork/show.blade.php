...
@section('content')
    <div id="details">
        ...
        <div class="date">
            ...
            <span>{{ $patchwork->created_at->format(trans('translations.date_format')) }}</span>
        </div>
        <div id="preview">
            <?= $patchwork->content ?>
        </div>
        ...
        <div id="fabric-list">
            ...
            @foreach( $patchwork->fabrics as $fabric)
                <div class="fabric">
                    <svg height="0">
                        <defs>
                            <pattern id="fabric-{{ $fabric->id }}" data-id="{{ $fabric->id }}" x="0" y="0" width="1"
                                     height="1">
        ...
        <div id="new-comment">
            ...
            <form method="POST" action="{{ route('patchwork.comment', $patchwork) }}">
